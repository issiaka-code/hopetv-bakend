<div class="modal fade" id="addprophetieModal" tabindex="-1" role="dialog" aria-labelledby="addprophetieModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addprophetieModalLabel">Ajouter une prophétie</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="addprophetieForm" method="POST" action="{{ route('propheties.store') }}"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Nom <span class="text-danger">*</span></label>
                        <input type="text" name="nom" id="addprophetieNom"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="addprophetieDescription"
                    ...
                    <div id="addAudioFileSection">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Formats acceptÃ©s: MP3, WAV, AAC, etc. (max 50MB)</small>
                        </div>
