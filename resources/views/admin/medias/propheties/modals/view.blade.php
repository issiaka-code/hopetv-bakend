<!-- Modal pour visualiser la prophetie -->
<div class="modal fade" id="prophetieViewModal" tabindex="-1" role="dialog" aria-labelledby="prophetieViewModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title mb-2" id="prophetieViewModalLabel">Prophétie</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mt-2 text-justify">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p id="prophetieDescription" class="text-muted mb-0"></p>
                        </div>
                    </div>
                </div>
            </div>
