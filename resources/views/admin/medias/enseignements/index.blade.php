                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <!-- Switch Publication -->
                                        <button class="btn btn-sm btn-outline-{{ $is_published ? 'success' : 'secondary' }} toggle-publish-btn mx-1 rounded" title="{{ $is_published ? 'Dépublier' : 'Publier' }}" data-enseignement-id="{{ $id }}" data-status="{{ $is_published ? 1 : 0 }}">
